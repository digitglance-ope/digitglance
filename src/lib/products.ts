...
export const PRODUCTS: Product[] = [
  {
    ...
    description: 'Create invoices, track payments, manage customers, suppliers, and inventory. Built for Nigerian VAT, WHT, and NRS compliance.',
...

  {
    ...
    description: 'Sell products, track stock, manage cash and card payments, and generate NRS-compliant VAT reports.',
    basePath: '/app/pos',
