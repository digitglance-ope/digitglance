...
export const PRODUCTS: Product[] = [
...

  {
    ...
    description: 'Sell products, track stock, manage cash and card payments, and generate daily sales reports.',
    basePath: '/app/pos',
...
// ── Platform-shared nav items (appear in sidebar for all products) ──────────
