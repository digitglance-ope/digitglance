          ...
          <div className="col-span-2 space-y-6">
              ...
              <div className="space-y-3">
                ...
                {items.map((item, index) => (
                  <div key={index} className="grid grid-cols-12 gap-2 items-center">
                    ...
                    <div className="col-span-2">
                      <div className="px-3 py-2 text-sm text-slate-700 font-medium">{formatCurrency(item.amount)}</div>
                    </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6">
              ...
              <textarea
                ...
                rows={3}
                className="w-full border border-slate-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-teal-500 resize-none"
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500">VAT ({form.vat_rate}%)</span>
                  <span className="text-slate-900 font-medium">{formatCurrency(vatAmount)}</span>
                </div>
