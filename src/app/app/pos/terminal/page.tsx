    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <main className="ml-64 flex-1 p-8">
        <div className="mb-6">
          ...
          <p className="text-slate-500 text-sm mt-1">Cashier screen — scan products, process payments, print receipts</p>
        </div>
        <PosComingSoon
          step="Step 4"
          features={[
            'Two-pane cashier interface (catalogue + cart)',
            'Barcode scanner support (USB HID)',
            'Keyboard shortcuts (F2 search, F10 charge, F1–F7 payment methods)',
            'Cash, card, transfer, USSD, OPay, credit, and voucher payments',
            'Split payment across multiple methods',
            'Customer credit check and A/R posting',
            'Hold and resume transactions',
            'Receipt printing (thermal / WhatsApp)',
          ]}
        />
      </main>
    </div>
