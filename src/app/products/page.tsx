            ...
            <div className="p-8 md:p-12">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-slate-500 mb-8 leading-relaxed">Create professional invoices, track payments, manage your clients, and get financial insights from one dashboard. Built specifically for how Nigerian businesses operate, with naira support and local tax considerations built in.</p>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a href="https://digitglance.com" target="_blank" className="bg-teal-600 text-white font-medium px-6 py-3 rounded-lg hover:bg-teal-700">
                      Open the App
                    </a>
                    <a href="/contact" className="border border-gray-200 text-slate-700 font-medium px-6 py-3 rounded-lg hover:border-teal-300">
                      Request a Demo
                    </a>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 rounded-xl p-8">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white border border-gray-100 rounded-xl p-6">
                      <p className="font-bold text-slate-900 text-lg mb-1">Free Plan</p>
                      <p className="text-3xl font-bold text-teal-600 mb-4">₦0 <span className="text-sm text-slate-400 font-normal">/ month</span></p>
                    ...
                    <div className="bg-teal-600 text-white rounded-xl p-6">
                      ...
                      <p className="text-3xl font-bold mb-4">₦5,000 <span className="text-sm text-teal-200 font-normal">/ month</span></p>
